/* =====================================================
   ASSIGNMENT WRITING PAGE — assignment-service.js
   Cloned from the shared service.js template.
   Handles: FAQ accordion + Package tab switcher
   Tier prices are derived from the real assignment-writing
   rate in Pricing page/js/pricing-config.js (৳200 / 500 words,
   urgency multipliers: Standard x1.0, Express x1.4, Rush x1.8)
   — update pricing-config.js first if the base rate changes.
   ===================================================== */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var svcPackages = {
    standard: {
      name: 'Standard',
      title: 'Standard Assignment Package',
      subtitle: 'A solid, well-researched assignment — on time.',
      price: 'Starting ৳600',
      bestValue: 'Great fit for short, single-topic assignments (up to 1,500 words)',
      features: [
        { icon: ICON.clock,      title: 'Delivery in 4 Days',    desc: 'Standard delivery timeline' },
        { icon: ICON.infinity,   title: '2 Free Revisions',      desc: 'Until requirements are met' },
        { icon: ICON.fileCheck,  title: 'Turnitin Plagiarism Report', desc: 'Included' },
    ...
    recommended: {
      name: 'Recommended',
      title: 'Recommended Assignment Package',
      subtitle: 'Everything you need for a complete assignment — professionally done.',
      price: 'Starting ৳1,700',
      bestValue: 'Best value for standard course assignments (up to 3,000 words, Express delivery)',
      features: [
        { icon: ICON.clock,      title: 'Delivery in 2 Days (Express)', desc: 'Faster turnaround' },
    ...
    premium: {
      name: 'Premium',
      title: 'Premium Assignment Package',
      subtitle: 'Everything you need for a complete assignment — professionally done.',
      price: 'Starting ৳3,600',
      bestValue: 'Best for urgent, high-priority assignments (up to 5,000 words, Rush delivery)',
      features: [
        { icon: ICON.clock,      title: 'Delivery in 24 Hours (Rush)',    desc: 'Guaranteed on-time delivery' },
  ...
  function renderPackage(key) {
    ...
    window._scriptoraSelectedAssignmentPkg = pkg; /* used by orderAssignmentPackage() */
